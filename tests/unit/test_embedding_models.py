    ...
    def test_embedding_error_with_cause(self):
        ...
        try:
            try:
                ...
                raise EmbeddingError("Wrapped error") from e
...
class TestModelConsistency:
    ...
    def test_model_serialization_roundtrip(self):
        ...
        assert (
            original_params.weights_for_different_modes
            == restored_params.weights_for_different_modes
        )
...
class TestModelValidationEdgeCases:
    ...
    def test_embedding_parameters_invalid_types(self):
        ...
        with pytest.raises(ValidationError):
            EmbeddingParameters(
                weights_for_different_modes="invalid"
    ...
    def test_embedding_result_missing_required_fields(self):
        ...
        with pytest.raises(ValidationError):
            EmbeddingResult(
                processing_time=1.0
            )  # Missing batch_size and memory_usage_mb
