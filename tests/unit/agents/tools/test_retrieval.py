...
class TestRetrieveDocuments:
    ...
    async def test_retrieve_documents_with_dspy_optimization(self, mock_dspy):
    ...
    async def test_retrieve_documents_fallback_optimization(self):
    ...
    async def test_retrieve_documents_deduplication(self):
    ...
    async def test_tool_collection_path_failure_fallbacks(self):
...
class TestParsingBoundaries:
    ...
    async def test_retrieve_parsing_string_result(self):
    ...
    async def test_retrieve_parsing_llamaindex_like_object(self):
    ...
    async def test_retrieve_parsing_document_list(self):
    ...
    async def test_retrieve_parsing_dict_list_passthrough(self):
    ...
    async def test_retrieve_parsing_fallback_conversion(self):
...
class TestAdditionalCoverage:
    ...
    @pytest.mark.asyncio
    async def test_graphrag_fallback_marks_strategy_used_as_hybrid(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_contextual_recall_includes_recent_sources_when_retrieval_empty(self):
    ...
    @pytest.mark.asyncio
    async def test_hybrid_empty_primary_falls_back_to_vector(self):
