...
Authoritative implementation of the Settings page. Streamlit auto-discovery
expects a `pages/` directory next to the main script; we keep a thin wrapper
file at `src/pages/04_settings.py` that simply calls `main()` from here.
"""
